                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" action="{{ route('receipts.store') }}"
                                  id="quickForm">
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select name="shop_name" class="form-control" onchange="set_config()"
                                                ...
                                                @foreach($settings as $setting)
                                                    <option value="{{$setting->id}}">{{$setting->shop_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 form-group">
                                                ...
                                                <input type="number" name="product_quantity1"
                                                       ...
                                                       value="1" placeholder="Enter Product Quantity">
                                            </div>
                                            <div class="col-md-3 form-group">
                                    ...
                                    <div class="fa-pull-right">
                                        <div class="row form-group">
                                            Sales tax :
                                            <p id="currency_symbol1">₹</p>
                                            <div class=""><p id="sales-tax-total"> 0.00</p></div>
                                            <input type="hidden" name="sales_tax_total" class="form-control"
                                                   id="sales_tax_total"></div>

                                        <div class="row form-group">
                                            Total Price :
                                            <p id="currency_symbol2">₹</p>
                                            <div class=""><p id="total-Price">&nbsp;0.00</p></div>
